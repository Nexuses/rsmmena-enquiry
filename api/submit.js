...
// Map service keys to full labels & descriptions
const serviceMeta = {
  vCISO: {
    label: 'vCISO Services',
    description: 'Cyber defence strategy, policy, architecture & org planning.'
  },
  MaturityAssessment: {
    label: 'Maturity Assessment (NIST)',
    description: 'Scoring maturity based on NIST framework & People/Controls readiness.'
  },
  GRC: {
    label: 'GRC Automation & Assessment',
    description: 'Compliance (ISO, COSO, SOX, Central Bank) & ITGC/Enterprise Risk.'
  },
  DigitalFootprint: {
    label: 'Digital Footprint Mapping',
    description: 'Analysis of external exposure and brand sentiment.'
  },
  VAPT: {
    label: 'Vulnerability Assessment (VAPT)',
    description: 'Blackbox/Greybox/Whitebox (Outside-in & Inside-out).'
  },
  RedTeaming: {
    label: 'Red Teaming',
    description: 'Adversary simulation to test detection/response.'
  },
  DevSecOps: {
    label: 'DevSecOps / Security as Code',
    description: 'Securing the SDLC and Cloud Applications.'
  },
  BAS: {
    label: 'Breach & Attack Simulation',
    description: 'Lab-based continuous validation of controls.'
  },
  SOC: {
    label: 'SOC as a Service',
    description: '24x7 Monitoring, Incident Management (Captive or Managed).'
  },
  ThreatIntel: {
    label: 'Threat Monitoring',
    description: 'Dark web monitoring & threat intelligence.'
  },
  IncidentResponse: {
    label: 'Incident Response & Forensics',
    description: 'Root cause analysis, kill-chain reconstruction (e.g. Ransomware/DDoS).'
  },
  OTSecurity: {
    label: 'OT Security',
    description: 'Assessments for Operational Technology & Industrial Control Systems.'
  },
  CyberDrills: {
    label: 'Cyber Drills / Table-Top',
    description: 'Workshops for IT/Non-IT Executives.'
  },
  Training: {
    label: 'Skill Assurance Programs',
    description: 'Lab-based training (B2B/B2C) & Onboarding programs.'
  }
};
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Handle services (can be array or single value)
    ...
    let leaderNames = fields['leaderName[]'] || fields.leaderName || [];
    let leaderRoles = fields['leaderRole[]'] || fields.leaderRole || [];
    let leaderSkills = fields['leaderSkill[]'] || fields.leaderSkill || [];
